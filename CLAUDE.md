...
- **Paragraph** : `number`, `text` (brut), `contains_quote`, `contains_citation`, `headings: List[str]`, `heading_candidates: List[str]` (extraction permissive pour la réconciliation bilingue), `runs: List[TextRun]` (texte découpé en fragments italique/gras)
